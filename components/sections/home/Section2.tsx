                ...
                <div className="container position-relative z-1">
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-6 col-md-12 order-2 ">
                            ...
                            <h2 className="text-dark my-3 text-anime-style-3">3+ Years Of Experience In IT Solutions</h2>
                            <p className="pb-4 text wow img-custom-anim-top">At NazraSoft - Our approach is professional, client-focused, and expertise-driven. We specialize in various IT services to meet your requirements. Our mission is all about trust, innovation, and delivering exceptional results for our valued clients. Let's grow your business together. </p>
                            <ul className="list-unstyled d-flex flex-wrap wow img-custom-anim-top">
                                <li className="d-flex align-items-center mb-3 gap-2 w-md-50 w-100">
                                    ...
                                    <p className="mb-0 text-dark text-uppercase">Web Design and Development</p>
                                </li>
                                <li className="d-flex align-items-center mb-3 gap-2 w-md-50 w-100">
                                    <div className="position-relative">
                                        <svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} viewBox="0 0 14 14" fill="none">
                                    ...
                                    <p className="mb-0 text-dark text-uppercase">E-commerce Solutions</p>
                                </li>
                                <li className="d-flex align-items-center mb-3 gap-2 w-md-50 w-100">
                                    <div className="position-relative">
                                        <svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} viewBox="0 0 14 14" fill="none">
                                    ...
                                    <p className="mb-0 text-dark text-uppercase">Seo Marketing</p>
                                </li>
                                <li className="d-flex align-items-center mb-3 gap-2 w-md-50 w-100">
                                    <div className="position-relative">
                                        <svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} viewBox="0 0 14 14" fill="none">
                                    ...
                                    <p className="mb-0 text-dark text-uppercase">Digital Marketing</p>
                                </li>
                                <li className="d-flex align-items-center mb-3 gap-2 w-md-50 w-100">
                                    <div className="position-relative">
                                        <svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} viewBox="0 0 14 14" fill="none">
                                    ...
                                    <p className="mb-0 text-dark text-uppercase">Social Media Management</p>
                                </li>
                                <li className="d-flex align-items-center mb-3 gap-2 w-md-50 w-100">
                                    <div className="position-relative">
                                        <svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} viewBox="0 0 14 14" fill="none">
                                    ...
                                    <p className="mb-0 text-dark text-uppercase">Ads Campaign Management</p>
                                </li>
                                <li className="d-flex align-items-center mb-3 gap-2 w-md-50 w-100">
                                    <div className="position-relative">
                                        <svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} viewBox="0 0 14 14" fill="none">
                                    ...
                                    <p className="mb-0 text-dark text-uppercase">Shopify Development</p>
                                </li>
                                <li className="d-flex align-items-center mb-3 gap-2 w-md-50 w-100">
                                    <div className="position-relative">
                                        <svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} viewBox="0 0 14 14" fill="none">
                                    ...
                                    <p className="mb-0 text-dark text-uppercase">WordPress Website</p>
                                </li>
                            </ul>
